...
async function main() {
  ...
  const user = await prisma.user.upsert({
    where: { email: 'julianna@explore.com' },
    update: {
      password: 'Wanderlust#2026',
    },
    create: {
      id: 'user-demo-julianna',
      ...
      bio: 'Mountain enthusiast and passionate globetrotter.',
    },
  });
  ...
  const destinations = [
    {
      ...
      highlights: JSON.stringify(['Matterhorn views', 'Glacier 3000', 'Lake Thun cruise', 'Fondue tasting']),
      isSaved: false,
    },
    {
      id: 'dest-bali',
      ...
      highlights: JSON.stringify(['Tegallalang Rice Terraces', 'Uluwatu Sunset Temple', 'Mount Batur Sunrise Hike', 'Nusa Penida']),
      isSaved: false,
    },
    {
      id: 'dest-paris',
      ...
      highlights: JSON.stringify(['Eiffel Tower twilight', 'Louvre Museum', 'Montmartre cafes', 'Seine river cruise']),
      isSaved: false,
    },
    {
      id: 'dest-manali',
      ...
      highlights: JSON.stringify(['Solang Valley adventure', 'Atal Tunnel pass', 'Old Manali cafes', 'Jogini Waterfalls']),
      isSaved: false,
    },
    {
      id: 'dest-dubai',
      ...
      highlights: JSON.stringify(['Burj Khalifa Sky Deck', 'Desert Safari Camp', 'Dubai Marina Yacht', 'Museum of the Future']),
      isSaved: false,
    },
    {
      id: 'dest-tokyo',
      ...
      highlights: JSON.stringify(['Shibuya Crossing', 'Senso-ji Asakusa', 'TeamLab Planets', 'Tsukiji Outer Market']),
      isSaved: false,
    },
  ];
  ...
  // 3. Seed Saved Trips for Demo User
  const demoSaved = ['dest-switzerland', 'dest-bali', 'dest-paris', 'dest-tokyo'];
  for (const destId of demoSaved) {
  ...
  console.log(`✅ Seeded ${demoSaved.length} wishlist items for demo user`);

  // 4. Seed Trips for Demo User
  const trips = [
    {
      id: 'trip-swiss-alps',
  ...
  console.log(`✅ Seeded ${trips.length} trips for demo user`);

  // 5. Seed Activities for Swiss Alps
  const activities = [
    {
      id: 'act-1',
  ...
  console.log('🎉 GlobeTrotter Database seeding complete!');
}
